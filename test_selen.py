...
def test_passing():
    ...
    login_1 = driver.find_element(By.CSS_SELECTOR, 'div.modal-login div.modal-content div.form-group '
                                                   '#input_login_01').send_keys('Sysdba')

    parol_1 = driver.find_element(By.CSS_SELECTOR, 'div.modal-login div.modal-content div.form-group '
                                                   '#input_password_01').send_keys('305')
